// src/App.jsx — Generated by VIA for: Build a simple full stack notes app with React frontend, Node.js backend, and MongoDB database with create, edit, delete, and login features.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build A Simple Full Stack Notes App With</span>
            </Link>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build A Simple Full Stack Notes App With</h1>
